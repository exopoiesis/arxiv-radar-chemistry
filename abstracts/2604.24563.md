...
**Topics:** Quantum Chemistry & Force Fields, via:author-whitelist:DFT methodology, ML for DFT, via:author-whitelist:Grotthuss, AIMD, via:author-whitelist:ML force fields, SchNet
